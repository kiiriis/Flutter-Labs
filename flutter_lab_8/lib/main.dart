...
*/
          Row(
            children: [
              Text('Hello world, Krish here\n'),
              Text('\n\n\n\nIt is part of Lab-08')
            ],
          ),
          Container(
            color: Colors.pink[800],
            padding: EdgeInsets.all(30.0),
            child: Text('I am inside container 1'),
          ),
          Container(
            color: Colors.amber,
            padding: EdgeInsets.all(50.0),
            child: Text('I am inside container 2'),
          ),
          Container(
            color: Colors.teal[800],
            padding: EdgeInsets.all(70.0),
            child: Text('I am inside container 3'),
          ),
        ],
      ),
    );
